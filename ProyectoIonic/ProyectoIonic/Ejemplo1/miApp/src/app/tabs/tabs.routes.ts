...
export const routes: Routes = [
  {
    ...
    children: [
      ...
      { path: 'polo1', loadComponent: () => import('../polo1/polo1.page').then(m => m.Polo1Page) },
      { path: 'polo2', loadComponent: () => import('../polo2/polo2.page').then(m => m.Polo2Page) },
      { path: 'polo3', loadComponent: () => import('../polo3/polo3.page').then(m => m.Polo3Page) },
