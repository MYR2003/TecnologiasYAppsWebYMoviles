...
export const routes: Routes = [
  {
    ...
    children: [
      ...
      { path: 'martin03', loadComponent: () => import('../martin03/martin03.page').then(m => m.Martin03) },
      { path: 'martin04', loadComponent: () => import('../martin04/martin04.page').then(m => m.Martin04) },
      { path: 'martin05', loadComponent: () => import('../martin05/martin05.page').then(m => m.Martin05) },
      { path: 'martin06', loadComponent: () => import('../martin06/martin06.page').then(m => m.Martin06) },
